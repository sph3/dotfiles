...
static const char *fonts[]          = { "JetBrainsMod:style:medium:size=10",
...
static const char *colors[][3]      = {
    ...
    [SchemeTag8]       = { maroon,  black,  black },
    [SchemeTag9]       = { sapphire,    black,  black },
...
static const Rule rules[] = {
	...
	{ "easyeffects",   	NULL,       NULL,       1 << 8,       0,           0,           -1 },
...
static Key keys[] = {
    ...
    // Overall gaps --------------------------------------------------------------
    { MODKEY|ControlMask,               XK_bracketleft,  incrgaps,   {.i = +1 } },
    { MODKEY|ControlMask,               XK_bracketright, incrgaps,   {.i = -1 } },
    ...
    // Inner + outer horizontal, vertical gaps -----------------------------------
    ...
    // Change focused window border size ----------------------------------------
...
static Button buttons[] = {
    ...
    */
    ...
    // { ClkClientWin,         ShiftMask,      Button1,        dragmfact,      {0} },
